...
const SUPPORTED_COINS: { symbol: string; name: string; basePrice: number; rank: number; category: string }[] = [
  { symbol: 'BTCUSDT', name: 'Bitcoin', basePrice: 88500, rank: 1, category: 'Layer 1' },
  { symbol: 'ETHUSDT', name: 'Ethereum', basePrice: 3150, rank: 2, category: 'Smart Contracts' },
  { symbol: 'SOLUSDT', name: 'Solana', basePrice: 188, rank: 3, category: 'Layer 1' },
  { symbol: 'BNBUSDT', name: 'BNB', basePrice: 620, rank: 4, category: 'Exchange / L1' },
  { symbol: 'XRPUSDT', name: 'XRP', basePrice: 2.15, rank: 5, category: 'Payments' },
  { symbol: 'ADAUSDT', name: 'Cardano', basePrice: 0.72, rank: 6, category: 'Layer 1' },
  { symbol: 'AVAXUSDT', name: 'Avalanche', basePrice: 28.5, rank: 7, category: 'Layer 1' },
  { symbol: 'LINKUSDT', name: 'Chainlink', basePrice: 16.8, rank: 8, category: 'Oracle / DeFi' },
  { symbol: 'SUIUSDT', name: 'Sui', basePrice: 3.25, rank: 9, category: 'Layer 1' },
  { symbol: 'DOTUSDT', name: 'Polkadot', basePrice: 7.4, rank: 10, category: 'Interoperability' },
  { symbol: 'NEARUSDT', name: 'NEAR Protocol', basePrice: 5.6, rank: 11, category: 'AI & Data / L1' },
  { symbol: 'APTUSDT', name: 'Aptos', basePrice: 11.2, rank: 12, category: 'Layer 1' },
  { symbol: 'ARBUSDT', name: 'Arbitrum', basePrice: 0.65, rank: 13, category: 'Layer 2' },
  { symbol: 'OPUSDT', name: 'Optimism', basePrice: 1.85, rank: 14, category: 'Layer 2' },
  { symbol: 'INJUSDT', name: 'Injective', basePrice: 24.5, rank: 15, category: 'DeFi / L1' },
  { symbol: 'RENDERUSDT', name: 'Render', basePrice: 6.8, rank: 16, category: 'AI & GPU' },
  { symbol: 'FETUSDT', name: 'Artificial Superintelligence', basePrice: 1.45, rank: 17, category: 'AI / ML' },
  { symbol: 'TAOUSDT', name: 'Bittensor', basePrice: 485, rank: 18, category: 'AI / Subnets' },
  { symbol: 'TIAUSDT', name: 'Celestia', basePrice: 5.8, rank: 19, category: 'Modular L1' },
  { symbol: 'KASUSDT', name: 'Kaspa', basePrice: 0.14, rank: 20, category: 'PoW / L1' },
  { symbol: 'ATOMUSDT', name: 'Cosmos', basePrice: 6.2, rank: 21, category: 'Interoperability' },
  { symbol: 'LTCUSDT', name: 'Litecoin', basePrice: 104, rank: 22, category: 'Payments' },
  { symbol: 'BCHUSDT', name: 'Bitcoin Cash', basePrice: 430, rank: 23, category: 'Payments' },
  { symbol: 'SEIUSDT', name: 'Sei', basePrice: 0.48, rank: 24, category: 'Trading L1' },
  { symbol: 'JUPUSDT', name: 'Jupiter', basePrice: 0.95, rank: 25, category: 'Solana DeFi' },
  { symbol: 'PYTHUSDT', name: 'Pyth Network', basePrice: 0.42, rank: 26, category: 'Oracle' },
  { symbol: 'UNIUSDT', name: 'Uniswap', basePrice: 9.8, rank: 27, category: 'DEX / DeFi' },
  { symbol: 'AAVEUSDT', name: 'Aave', basePrice: 195, rank: 28, category: 'Lending / DeFi' },
  { symbol: 'MKRUSDT', name: 'Maker', basePrice: 1680, rank: 29, category: 'DeFi / Stable' },
  { symbol: 'STXUSDT', name: 'Stacks', basePrice: 1.92, rank: 30, category: 'Bitcoin L2' },
  { symbol: 'RUNEUSDT', name: 'THORChain', basePrice: 5.2, rank: 31, category: 'Cross-chain' },
  { symbol: 'ICPUSDT', name: 'Internet Computer', basePrice: 10.5, rank: 32, category: 'Web3 Cloud' },
  { symbol: 'FILUSDT', name: 'Filecoin', basePrice: 4.8, rank: 33, category: 'Storage' },
  { symbol: 'GRTUSDT', name: 'The Graph', basePrice: 0.22, rank: 34, category: 'Indexing / Data' },
  { symbol: 'WLDUSDT', name: 'Worldcoin', basePrice: 2.1, rank: 35, category: 'Identity / AI' },
  { symbol: 'PENDLEUSDT', name: 'Pendle', basePrice: 4.6, rank: 36, category: 'Yield DeFi' },
  { symbol: 'ONDOUSDT', name: 'Ondo Finance', basePrice: 1.28, rank: 37, category: 'RWA' },
  { symbol: 'IMXUSDT', name: 'Immutable', basePrice: 1.55, rank: 38, category: 'Gaming / L2' },
  { symbol: 'GALAUSDT', name: 'Gala', basePrice: 0.028, rank: 39, category: 'Gaming' },
  { symbol: 'ALGOUSDT', name: 'Algorand', basePrice: 0.24, rank: 40, category: 'Layer 1' },
  { symbol: 'QNTUSDT', name: 'Quant', basePrice: 86, rank: 41, category: 'Enterprise' },
  { symbol: 'ARUSDT', name: 'Arweave', basePrice: 17.5, rank: 42, category: 'Permanent Storage' },
  { symbol: 'MANAUSDT', name: 'Decentraland', basePrice: 0.38, rank: 43, category: 'Metaverse' },
  { symbol: 'SANDUSDT', name: 'The Sandbox', basePrice: 0.34, rank: 44, category: 'Metaverse' },
  { symbol: 'AXSUSDT', name: 'Axie Infinity', basePrice: 6.4, rank: 45, category: 'Gaming' },
  { symbol: 'FTMUSDT', name: 'Sonic / Fantom', basePrice: 0.88, rank: 46, category: 'Layer 1' },
  { symbol: 'THETAUSDT', name: 'Theta Network', basePrice: 1.82, rank: 47, category: 'Video / AI' },
  { symbol: 'HNTUSDT', name: 'Helium', basePrice: 6.10, rank: 48, category: 'DePIN' },
  { symbol: 'EOSUSDT', name: 'EOS', basePrice: 0.68, rank: 49, category: 'Layer 1' },
  { symbol: 'XTZUSDT', name: 'Tezos', basePrice: 0.95, rank: 50, category: 'Layer 1' },
  { symbol: 'FLOWUSDT', name: 'Flow', basePrice: 0.72, rank: 51, category: 'NFT / L1' },
  { symbol: 'NEOUSDT', name: 'NEO', basePrice: 13.4, rank: 52, category: 'Smart Economy' },
  { symbol: 'KAVAUSDT', name: 'Kava', basePrice: 0.45, rank: 53, category: 'Cosmos DeFi' },
  { symbol: 'MINAUSDT', name: 'Mina Protocol', basePrice: 0.62, rank: 54, category: 'ZK / L1' },
  { symbol: 'ENAUSDT', name: 'Ethena', basePrice: 0.58, rank: 55, category: 'Synthetic USD' },
  { symbol: 'CRVUSDT', name: 'Curve DAO', basePrice: 0.52, rank: 56, category: 'DEX / Stable' },
  { symbol: 'SNXUSDT', name: 'Synthetix', basePrice: 1.75, rank: 57, category: 'Derivatives' },
  { symbol: 'LDOUSDT', name: 'Lido DAO', basePrice: 1.35, rank: 58, category: 'Liquid Staking' },
  { symbol: 'DYDXUSDT', name: 'dYdX', basePrice: 1.25, rank: 59, category: 'Perpetuals DEX' },
  { symbol: 'BLURUSDT', name: 'Blur', basePrice: 0.28, rank: 60, category: 'NFT Trading' },
];
